...
def check_winner():
    ...
    if b1['text'] == 'X' and b2['text'] == 'X' and b3['text'] == 'X':
        ...
        b3.config(bg='red')
        winner = True
        messagebox.showinfo(title='Winner winner chicken dinner', message="X has won")
        disable_all_buttons()
        ...
        b3.config(bg='red')
        winner = True
        messagebox.showinfo(title='Winner winner chicken dinner', message="O has won")
        disable_all_buttons()
    ...
    if count == 9 and winner == False:
        disable_all_buttons()
        messagebox.showinfo(title='Draw', message="TIE!")
...
def b_click(b):
    ...
    if b['text'] == " " and clicked == True:
        ...
        messagebox.showerror(message="Position already filled bozo!")
